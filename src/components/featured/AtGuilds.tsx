    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-16 sm:px-10 sm:py-24">
        <div className="flex items-center justify-between gap-3">
          ...
          <span className="shrink-0 rounded-full bg-ink px-3 py-1 font-mono text-xs tracking-widest text-wrap-yellow uppercase">
          ...
          <div className="mt-12">
            ...
            <ul className="mt-4 grid gap-2 sm:grid-cols-2">
              {data.guilds.map((g) => (
                <li
                  key={g.uri}
                  className="min-w-0 overflow-hidden rounded-xl border-2 border-ink bg-cream p-3"
                >
